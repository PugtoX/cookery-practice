...
panel as the DNS you are already touching. Sending *as* the domain is the part to get
right: forwarding alone will not do it, and it needs a real sending service. I will test
send and receive before calling it done, and tell you plainly if the plan you choose
cannot do both.
